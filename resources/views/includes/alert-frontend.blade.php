{{-- error --}}
<div class="alert alert-danger" v-cloak v-if="alert.error != null">
...
{{-- warning --}}
<div class="alert alert-warning" v-cloak v-if="alert.warning != null">
